...
Write a python program to create a Snake Water game in Python using if-else statements. Do no create any fancy GUI. Use proper functions to check for win.
'''
